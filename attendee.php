...
<?php
	...
	while($row1 = mysqli_fetch_array($result1))
	{
		...
		echo "<th><Number></th><th>Name</th><th>Email</th>";
		$result2 =  mysqli_query($link,"SELECT user.name, user.email from user, event, participant_list where event.title ='".$row1["title"]."' AND participant_list.userId = user.userId AND participant_list.eventid = event.eventid");
