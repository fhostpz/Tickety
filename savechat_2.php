<?php
  ...
  //check connection
  if (!$link) {
    die ("Error, please contact the web administr3afator: " . mysqli_error($link));
  }
  ...
  if (!$result) {
    die ("Error, please contact the web administrator123: " . mysqli_error($link));
  }
  ...
  if (!$result) {
    die ("Error, please contact the web administrat332or: " . mysqli_error($link));
  }
  ...
  if (!$result) {
    die ("Error, please contact the web admin11istrator: " . mysqli_error($link));
  }
