				...
				echo
					'<table cellspacing = "40px">
						...
						<form method = "post" action = "UpdateProfile.php">
							...
							<tr>
								<td>
									<a class="link" href="attendee.php">Organized Events</a> 
								</td>
								<td align = "right">
			...
			<h1>Purchase History</h1>
				<table class = "eventTable">
					...
					<?php
						...
						if ($result = mysqli_query($link, "SELECT event.event_title, event.event_date, participant_list.noOfTickets FROM event, participant_list, user WHERE participant_list.userID=user.userID and event.event_id=participant_list.eventID and user.userID=$userID")) {
						...
						$query = "SELECT event.event_title, event.event_date, participant_list.noOfTickets FROM event, participant_list, user WHERE participant_list.userID=user.userID and event.event_id=participant_list.eventID and user.userID=$userID ORDER BY event.event_date ASC";
