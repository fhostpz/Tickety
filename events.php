	...
	<body>
		...
		<div class = "eventBox">
			<?php
				...
				$query = "SELECT * FROM event WHERE event_date > '$date_str' ORDER BY event_date ASC";
				$result = mysqli_query($link, $query);
				...
				for($x=0; $x<$row_cnt; $x++)
				{
					echo "<div class = 'eventCard'>
						...
						<a href = '#' onclick=\"toggle_description('".$array[$x]['event_id']."')\">
						...
						<div class = 'eventDate'>
							".$array[$x]['event_date']."
							<button onclick = \"document.getElementsByName('".$array[$x]['event_id']."')[0].style.display='block'\" class = 'cardButton'>Buy Now</button>
								
								<div name = '".$array[$x]['event_id']."' class = 'modal'>
									<span onclick=\"document.getElementsByName('".$array[$x]['event_id']."')[0].style.display='none'\" class='close' title='Close Modal'>&#10006;</span>
									<form method = 'post' action = 'payment.php' class = 'modal-content'>
										<div class = 'buyTicketContainer'>
											...
											<br>
											<input name = 'numTickets' type = 'number' min = 0 style = 'width: 50%;' onchange = \"document.getElementById('".$array[$x]['event_id']."total_price').value=(".$array[$x]['event_price']."*value)\"/>
											<br>
											<hr>
											<label style = 'margin-left: 360px'><b>Total Price</b></label>
											<p style = 'margin-left: 360px'>
												RM<input id = '".$array[$x]['event_id']."total_price' value='' readonly>
											</p>
											<p style = 'margin-left: 360px; display: none'>
												Event ID<input name = 'eventid' value='".$array[$x]['event_id']."' readonly>
											</p>
											<div class = 'clearfix'>
